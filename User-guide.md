...
layout: default
title: User Guide
description: Updates in Progress - June 2026
---
...
If you're brand new and just want to get up and running fast, start with the [**5-Minute Starter Guide**](5-minute-starter-guide.html) instead. Come back here when you're ready to go deeper.
...
2. [Managing Your Classes](#managing-your-classes)
3. [Managing Your Team](#managing-your-team)
4. [Running Assessments](#running-assessments)
5. [Assessment Settings & Customization](#assessment-settings--customization)
6. [Tracking Your Class](#tracking-your-class)
7. [Student Profiles](#student-profiles)
8. [Reports](#reports)
9. [Settings and Account](#settings-and-account)
...
4. Tap **Next** to move on to adding students
You can always create additional classes from the Dashboard later.
...
- **Birth month and year** — optional. Used to calculate the student's age for display purposes. We collect month and year only — no day — because that's genuinely all we need, and we'd rather not have it if we don't.
- **Avatar** — optional. Choose from a set of animal avatars, or leave the default to show the student's initials.
*[screenshot: add student dialog]*
 
---
 
That's it — your class is ready and you're on the Dashboard. From here, the fastest next step is running your first assessment. See [Running Assessments](#running-assessments) to get started, or keep reading to learn more about managing your class.
...
4. Tap **Save**
Your first class is created during onboarding when you first sign up.
 
**To edit a class:**
1. Tap the three-dot menu in the top right
2. Select **Edit Class**
3. Make your changes and tap **Save**
You can change the class name, grade level, and avatar at any time.
...
5. Tap **Add**
A first name is all that's required. See the note in [Getting Started](#getting-started) for a full guide on what information to enter and what to skip.
...
10. Tap **Send Request**
The receiving teacher gets a notification and must accept before the transfer is complete. Transfer requests expire after 30 days if not accepted. If you chose to archive or remove your copy, that won't happen until the transfer is accepted — your data is safe in the meantime.
...
8. Tap **Transfer**
No approval needed — the move happens immediately.
...
7. Tap **Send Request**
The receiving teacher will see every student's complete assessment history from day one. That's the work you did all year, ready and waiting for them before school even starts.
...
6. Tap **Delete Class**
The type-to-confirm step is intentional. It gives you a moment to make sure this is really what you want.
...
2. Tap **Show Archived** near the top of the student list
Archived students appear separately from your active roster. Their data is fully intact — you can view their assessment history, generate reports, and unarchive them if needed.
...
6. Tap **Delete Student**
Deletion is permanent. If a student is leaving temporarily or transferring to another class or teacher, consider archiving or transferring instead.
...
The invited teacher will receive an email with instructions to accept. They'll need an abcAssess account — if they don't have one yet, they can create one for free when they accept the invitation.
...
3. Tap **Accept**
Once accepted, the class appears in your Dashboard alongside your own classes. If you're an assistant, you'll see it in your class list but with limited access consistent with your role.
...
6. Tap **Send Invitation** to confirm
The teacher receives a notification and must accept the role change before it takes effect. This is intentional — a significant change in access should require their acknowledgment.
...
The teacher loses access to that class immediately and will be notified. Any assessments they completed remain in your records — removing a teacher doesn't delete their contributions.
...
- You can run assessments and add notes for any student in that class
- You cannot view reports, change settings, or edit the roster
- The class appears in your Dashboard but with limited controls visible
- If the class owner archives the class, you'll lose access — archiving a shared class notifies all connected teachers
If you need more access than your role allows, ask the class owner to change your role to Co-Teacher.
...
- Shapes
- Beginning Sounds
**Custom assessments** are ones you've built yourself. See [Assessment Settings & Customization](#assessment-settings--customization) for how to create them.
...
Tap the honey-colored assessment button on any student's card. The assessment picker opens for that student.
 
**From the student profile:**
Open a student's profile and tap **Start Assessment**.
...
- **The item** — large and centered, easy to show the student
- **Progress bar** — thin bar at the top showing how far through the assessment you are
- **Student name** — confirms you're assessing the right child
- **Item counter** — "1 of 26" so you always know where you are
- **Unknown button** (left, terracotta with ✗) — the student didn't know this one
- **Known button** (right, sage with ✓) — the student knew this one
- **Back arrow** — between the two buttons, goes back one item if you need to correct a response
- **Pause button** — top right, freezes the assessment
- **X button** — top left, exits the assessment
- **+ Note** — at the bottom, add a per-item observation
*[screenshot: assessment flashcard screen]*
...
**On screen:**
Tap **Unknown** (left) or **Known** (right) for each item. The next item appears automatically.
 
**Keyboard shortcuts:**
If you're using a laptop or keyboard-connected device, use the arrow keys:
- **← Left arrow** — Unknown
- **→ Right arrow** — Known
- **Backspace** — go back to the previous item
- **↓ Down arrow** — open the per-item note field
Keyboard shortcuts are one of the most useful features in abcAssess — especially in a live classroom setting.
...
*[screenshot: paused assessment screen]*
*[screenshot: adult lock — pause]*
...
**Tapping the X to exit intentionally:**
If you tap the **X** button during an assessment, you'll first see the same *"Type the number [word]"* challenge — this prevents a student from accidentally tapping X and losing your progress. The exit lock shows a terracotta X icon (rather than the pause lock's lock icon) and includes a reminder: *"Exiting now will not save this assessment's progress."*
...
**To enable Timed Mode:**
At the bottom of the assessment picker, tap **Timed Mode** to expand the settings. Toggle it on and choose your options:
 
**Duration:** 30 seconds / 60 seconds / 90 seconds / Custom
 
**When time expires:**
- **Mark & continue (default — recommended)** — when the timer runs out, the app automatically marks which item the student was on, plays a brief sound, and the assessment continues through all remaining items without interruption. You end up with both a fluency score (items reached within the time) and a full mastery score (all items).
- **Stop at time** — the assessment ends automatically when the timer runs out and goes straight to results.
**The timer during assessment:**
When Timed Mode is active, a small unobtrusive countdown timer appears in the corner of the assessment screen. It's small enough that a student sitting across a table can't easily see it — and that's intentional. Young children who know they're being timed can experience anxiety that affects their performance and skews your results. The student should never be aware a timer is running.
 
**Why Mark & Continue is recommended:**
With Mark & Continue, you get two complete data points from one assessment sitting — a timed fluency benchmark and a full mastery picture. This means you never need to assess the same child twice to get both scores, which is especially useful for DIBELS-style letter knowledge assessments.
 
**Results with Timed Mode:**
When Timed Mode was active, the results screen shows both scores clearly:
- **Full assessment:** 23/26 — 88% ✓ Proficient
- **60-second fluency:** 19 items reached, 19 known
Both scores are saved with the assessment record and appear in the student's history, teacher reports, and the Progress Over Time chart (where you can toggle between the fluency score and the full score).
 
*[screenshot: timed mode toggle in assessment picker]*
*[screenshot: timed mode timer during assessment]*
*[screenshot: results screen with timed mode scores]*
...
- **Score** — percentage and fraction (e.g. 19/26 — 73.1%)
- **Proficiency level** — Proficient, Developing, or Emerging, with the ✓ ~ or ! symbol matching your configured thresholds
- **Saved** — a confirmation that the assessment was saved successfully
- **Known and Unknown counts** — at a glance summary
- **Go Back to Last Question** — if you immediately realize you made a mistake
- **Add a comment** — optional notes about the overall assessment (teacher reports only, not parent reports)
- **Items to Practice** — the specific items the student answered incorrectly, listed alphabetically or numerically
- **What's Next** — your options for what to do next
...
7. Tap **Save Assessment**
The **Select All then uncheck** approach is often faster for high-scoring students. If a student got 20 out of 26, it's quicker to select all and uncheck 6 than to check 20 individual items.
...
*[screenshot: manual entry — assessment type picker]*
*[screenshot: manual entry — item grid]*
...
- Shapes
- Beginning Sounds
Toggle any assessment on or off from the **Manage Assessments** tab. Disabled assessments won't appear in the assessment picker for any student in your class — unless you've enabled them individually for a specific student via per-student overrides.
...
6. Tap **Save**
**One rule:** the Developing threshold must always be lower than the Proficient threshold. abcAssess will prevent you from saving if they overlap.
...
4. Tap **Save**
Students with overrides will show a small **Custom** indicator so you can see at a glance that their settings differ from the class default.
 
**To reset a student back to class defaults:**
1. Open their assessment overrides
2. Tap **Reset to Class Defaults**
3. Tap **Save**
*[screenshot: per-student override screen]*
*[screenshot: custom indicator on student profile]*
...
7. Tap **Save**
Your custom assessment will appear in the assessment picker for all students in your class (unless overridden individually).
 
**Custom assessment items can include:**
- Text only — a word, letter, number, or phrase
- An image — useful for picture-based assessments
- An audio prompt — record your own voice for consistent verbal prompts
*[screenshot: custom assessment builder]*
...
*[screenshot: tracking chart — mix of filled and empty cells showing window in progress]*
*[screenshot: tracking chart — fully completed window]*
...
- ✓ is always Proficient — regardless of whether you can distinguish sage green
- ~ is always Developing — the tilde visually suggests "in progress"
- ! is always Emerging — the exclamation mark signals "needs attention"
- — is always Not Applicable — clearly distinct from an empty cell
This matters in reports too — all printed and PDF reports use the same symbol and pattern system so they're accessible in black and white.
...
3. Tap **Save**
The countdown to your window's end date appears on the Dashboard so you always know how much time you have left.
...
*[screenshot: set assessment window]*
*[screenshot: date filter options in tracking chart]*
...
**To enable manual edit mode:**
Tap the **Manual Edit** toggle at the top of the tracking chart. When it's on, tapping any cell cycles through the available states:
 
- **Tap once** — ✓ Proficient (sage)
- **Tap twice** — ~ Developing (amber)
- **Tap three times** — ! Emerging (terracotta)
- **Tap four times** — * Assessed, pending entry (white/neutral — use this when you know the student has been assessed but haven't entered the results yet)
- **Tap five times** — back to empty
Turn the toggle off when you're done to prevent accidental changes.
 
**The dot indicator:**
Every cell that has been manually set shows a small dot in the corner. This distinguishes manually updated cells from cells populated by live or manually-entered assessments at a glance — so you always know which parts of your chart reflect recorded data and which are placeholders.
 
*[screenshot: manual edit toggle]*
*[screenshot: tracking chart with manually set cells showing dot indicators]*
...
- **From the student list** — tap a student's name or avatar
- **From the tracking chart** — tap any cell in a student's row (when manual edit mode is off)
- **From the results screen** — tap **Return to [Student Name]** after completing an assessment
- **From the Dashboard roster** — tap any student's name or progress circle
*[screenshot: student profile — top of page]*
...
- **Score** — percentage and fraction (e.g. 23/26 — 88%)
- **Proficiency level** — Proficient, Developing, or Emerging based on your configured thresholds
- **Symbol** — ✓ ~ or ! so the level is clear at a glance
- **Last assessed date** — when this score was recorded
Only assessments that are active for this student appear here — if an assessment has been disabled class-wide or via a per-student override, it won't show up. Tap any assessment type to jump directly to that assessment's history.
...
**Reading the chart:**
- Each data point represents one completed assessment
- The horizontal axis shows dates
- The vertical axis shows score percentage
- Two threshold lines show where Proficient and Developing begin, labeled and colored to match their proficiency band — so you can see at a glance whether a student's trajectory is heading toward proficiency, approaching it, or still well below
**Switching assessment types:**
Use the dropdown above the chart to switch between assessment types. Each type has its own line, colored to match its assigned color in the Current Mastery list.
 
**Class average overlay:**
Toggle on the class average to see how this student's trajectory compares to the rest of the class. Useful for identifying students who are falling behind the class pace or pulling ahead — and for reassurance that a student who appears low is actually tracking with the group.
 
*[screenshot: progress over time chart with threshold lines]*
*[screenshot: class average overlay toggled on]*
...
Each entry shows:
- Assessment type and assigned color dot
- Date completed and teacher who completed it
- Score — fraction and percentage
- Proficiency level with symbol (✓ ~ !)
Tap any entry to expand it and see the item-level results — which specific items the student got right (✓) and wrong (✗), listed out clearly.
 
*[screenshot: assessment history list]*
*[screenshot: expanded assessment entry with item-level results]*
...
- **Full assessment** — e.g., 23/26, 88% ✓ Proficient
- **60-second fluency** — e.g., 19 items reached, 19 known
This gives you the complete picture from a single assessment sitting — mastery across the full set and fluency within the timed window — without needing to assess twice.
...
Edited assessments show a small indicator noting they were modified. The score recalculates automatically and all reports update to reflect the correction. The sticky save bar at the bottom stays visible while you're making changes — tap **Undo Changes** if you want to discard your edits before saving.
...
3. Confirm deletion
Deleted assessments are permanently removed and cannot be recovered. All reports and progress charts update automatically. If you're not sure, editing is almost always a better option than deleting.
...
- **Edit Student** — update the student's first name, last initial, birth month and year, or avatar
- **Transfer** — move the student to another class within your account, or send them to another teacher
- **Archive** — remove the student from your active roster without deleting their data
- **Delete Student** — permanently remove the student and all their assessment history
For Transfer, Archive, and Delete, you'll be walked through the same multi-step flows as the class-level equivalents — with a data handling step and type-to-confirm for deletion, so nothing irreversible happens by accident.
...
**Left — Class Averages by Assessment**
Shows your current class averages across all assessment types with progress bars and assessed counts.
 
**Center — Growth Over Time & Item-by-Item Breakdown**
Shows the class Growth Over Time chart (switchable by assessment type) and an item-by-item breakdown of how the class performed on each individual item.
 
**Right — Class Analytics & Individual Downloads**
Where you generate and download PDF reports — class-level reports at the top, individual student reports in the middle, and Bulk Downloads at the bottom.
...
**What it includes:**
- Student name and assessment date
- Score — percentage and fraction
- Proficiency level with symbol (✓ ~ !)
- All items assessed with Known/Unknown results (✓ and ✗)
- Items to Practice — specific items missed, listed alphabetically or numerically
- Per-item notes added during or after the assessment
- Duration (if duration recording was enabled)
- Timed fluency score (if applicable)
- Your configured proficiency thresholds
- Confidential footer on every page
The Teacher Report is the most detailed report. It's designed for professional use — not for sending home to parents.
...
**What it includes:**
- Student name and assessment date
- Score with proficiency level in plain language
- Which items the child knows — displayed as a visual grid, alphabetically sorted
- Items still being learned — framed positively
- Progress over time chart showing growth
- A note section where you can add a personal message to the family
**What it does NOT include:**
- Per-item teacher notes
- Proficiency threshold percentages
- Duration or fluency data
- Anything that could be misinterpreted without professional context
The parent report uses plain, warm language designed for families — not educational jargon. "Numerals" instead of "Numbers." Positive framing throughout. Confidential footer included on every page.
...
**What it includes:**
- Two or more assessment results for the same student and assessment type side by side
- Growth Over Time chart with proficiency threshold lines
- Class average overlay (optional)
- Score at each assessment point with proficiency level
- Items mastered since last assessment — what's new in the Known column
- Items still in progress
- Fluency growth over time (if timed assessments were used)
The progress report answers the question parents and administrators most want to know: *"Has this child grown?"* It shows the trajectory, not just the current snapshot.
...
**What it includes:**
- All students in the class with current proficiency levels for each assessment type
- Class average scores
- Distribution summary — how many Proficient, Developing, Emerging per assessment type
- Item breakdown — which specific items are most commonly missed across the class
- Optional proficiency zone shading on charts
- Fluency column (optional, when timed assessments exist)
The class report is about the whole group — useful for identifying patterns, planning small groups, and showing program-level outcomes.
...
**What it includes:**
- A ranked list of all items by class performance (highest to lowest)
- How many students got each item correct
- Color-coded by proficiency band so you can quickly see which items the class has mastered and which need more focus
*[screenshot: itemized assessment report PDF]*
...
**What it includes:**
- Each student's scores across multiple assessment dates in a single table
- Class averages at each assessment point
- Total Proficient / Developing / Emerging summary rows on every page
- Growth Over Time charts per assessment type
*[screenshot: class progress report PDF]*
...
4. Tap **Download PDF**
**To generate an individual student report:**
1. Go to the **Reports** page
2. In the right column under **Individual Downloads**, tap the report type
3. Select the student
4. Select the assessment type and time period
5. Tap **Download PDF**
The report dialog has three tabs:
- **Options** — customize what appears in the report
- **Assessments** — select which assessment dates to include
- **Preview** — see exactly what will download before committing
The Download button is accessible from all three tabs so you never have to navigate back to download.
 
*[screenshot: report dialog — options tab]*
*[screenshot: report dialog — preview tab]*
...
*Note: Assessment settings for your classes live in the Class Assessment Settings dialog on your class page — not here. See [Assessment Settings & Customization](#assessment-settings--customization) for details.*
...
Your profile includes your name, email address, and optionally your school and grade(s) taught — that's it. Just like with student data, we only ask for what's actually useful. Your name can be anything that works for you — a first name, "Mrs. Smith," whatever you go by in your classroom. No phone number, no home address, no personal details beyond what you choose to share.
...
1. Go to **Settings → Profile & Security**
2. Tap **Enter Password to Edit** — you'll be prompted to enter your current password first. This section contains your security settings, so it requires verification before any changes can be made.
3. Update your password and tap **Save**
**Connecting or disconnecting Google or Apple sign-in:**
1. Go to **Settings → Profile & Security → Enter Password to Edit**
2. Find **Connected Accounts**
3. Connect or disconnect as needed
*Note: If Google or Apple sign-in is your only sign-in method, set a password before disconnecting — otherwise you'll be locked out of your account.*
...
**To switch modes:**
Tap the **Light / Dark** toggle in the top right corner of any page.
...
Go to **Settings → Subscription & Billing** to see your current plan, renewal date, and billing details.
 
abcAssess offers two plans:
- **Monthly** — $5/month
- **Annual** — $50/year (saves $10 compared to monthly)
**To change your plan:**
Tap **Change Plan** to switch between Monthly and Annual.
 
**To update your payment method:**
Tap **Update Payment Method**. All payment processing is handled securely by Stripe — abcAssess never sees or stores your card details.
 
**To cancel your subscription:**
Tap **Cancel Subscription**. Your access continues until the end of your current billing period. Cancelling does not delete your data — see [What Happens When You Cancel](#what-happens-when-you-cancel) below.
...
**When you cancel:**
- Full access continues until the end of your current billing period
- After that, your account enters **read-only mode for 60 days** — you can view data and download reports but cannot run new assessments or add students
- At day 90 from the lapse date, your account and all data are permanently deleted
You'll receive reminder emails at lapse, at 14 days, and at 25 days. You can resubscribe at any time during this period to immediately restore full access.
...
- Number of assessments waiting to sync
- Last sync attempt timestamp
- **Sync Now** button to manually trigger a sync
**Before retiring, resetting, or losing a device:** check Pending Sync to confirm all assessments have uploaded. Unsynced assessments on a lost or reset device cannot be recovered.
...
4. Tap **Download**
The download only begins after your acknowledgment is confirmed and logged.
 
**To upload/restore from a backup:**
1. Go to **Settings → Backup**
2. Tap **Upload Backup**
3. Select your backup file and confirm
Uploading merges backup data with your current account — it does not overwrite existing records.
...
**Before you delete:**
- Download a backup if you want to keep your records
- Transfer any students or classes to another teacher if appropriate
- Let any co-teachers or assistants know they will lose access
**If you share classes with co-teachers:**
Deleting your account doesn't delete shared classes — ownership transfers automatically so co-teachers don't lose access to their students' data.
 
- If a class has **one co-teacher**, they automatically become the owner.
- If a class has **multiple co-teachers**, you'll be prompted to select who takes ownership before deletion can complete.
- **Assistant teachers** are removed from the class when you delete your account, since assistants don't have ownership rights.
This happens as part of the deletion flow — you won't be able to complete account deletion until all shared classes have an assigned new owner.
...
Deletion begins immediately. Data is removed from active systems right away and from encrypted backups within 30 days.
...
**What we collect:**
- Student first name — required, so you can identify students in your class
- Student last initial — optional, helpful if you have two students with the same first name
- Student birth month and year — optional, used only to calculate age for display purposes
- Assessment results — the scores and item-level responses from assessments you run
**What we deliberately don't collect:**
- Full legal names
- Full birth dates (month and year only — never the day)
- Home addresses
- Phone numbers
...
This isn't accidental — every data field in abcAssess was a deliberate choice. If we don't need it to deliver the assessment service, we don't collect it.
...
- A database breach would expose encrypted data, not readable student records
- abcAssess staff cannot read student data even if they wanted to
- Your students' information is protected at every step of the journey
Data in transit is also encrypted using TLS 1.3 — the same standard used by banks and financial institutions.
...
- Students experience assessments as a natural interaction with their teacher — not as a technology experience
- No COPPA concerns about children's online activity
---
...
See [Managing Your Classes](#managing-your-classes) for how to transfer students.
...
See [Managing Your Classes](#managing-your-classes) for deleting individual students or classes, and [Settings and Account](#settings-and-account) for deleting your full account.
...
- Parents and eligible students have the right to access them
- You cannot share them with unauthorized third parties
- You are responsible for keeping them secure
**abcAssess operates as a "School Official"** under FERPA — meaning we process student data only under your direction and only for legitimate educational purposes. We don't use your students' data for anything else.
 
**Your responsibilities as a teacher using abcAssess:**
- Only enter data about students you have legitimate educational authority over
- Don't share your login credentials with unauthorized individuals
- Store backup files securely and dispose of them properly when no longer needed
- When you download a backup, you're accepting responsibility for that file
**If you teach outside the U.S.:**
Similar protections apply under PIPEDA (Canada), the Australian Privacy Principles, the NZ Privacy Act, UK GDPR, and EU GDPR. abcAssess complies with all of these. The full details are in the Privacy Policy on the support center.
...
- **Privacy and legal requests:** legal@abcassess.app
We aim to respond within 2 business days for general questions and within 30 days for formal data rights requests.
...
**Check the student's assessment history first:**
Go to the student's profile and look at their assessment history. Assessments save automatically when you complete them — it may already be there.
 
**Check Pending Sync:**
Go to **Settings → Pending Sync**. If the assessment is waiting to upload, tap **Sync Now** and make sure you have a connection.
 
**If it's genuinely missing:**
If the assessment isn't in history and isn't in Pending Sync, it may not have saved. This can happen if the app was force-closed mid-assessment before the draft was committed. Use Manual Entry to log the results if you remember them, or re-assess the student.
...
5. Log out and log back in — this refreshes your session and often resolves the problem
If none of the above works, contact support@abcassess.app with a description of what you're seeing and your device type.
 
---
 
### The app is running slowly
 
- Check your internet connection — a slow connection can affect performance
- Close other apps to free up memory on your device
- Restart the app completely
- Restart your device
- Check for app updates — make sure you're running the latest version
If performance problems persist, contact support@abcassess.app with your device type and a description of what's happening.
...
- If a student is leaving your class temporarily, consider **archiving** them rather than deleting
- If a student is transferring to another teacher, use the **transfer** feature rather than deleting and re-entering
- Download a **backup** regularly — while it can't restore deleted students automatically, it gives you a record you could use to manually re-enter data if needed
---
 
### I can't find a student I know I added
 
**Check archived students:**
Students who have been archived don't show in your active roster. In your class tap **Show Archived** to see if they're there. You can unarchive them from there.
 
**Check your other classes:**
If you have multiple classes, make sure you're looking in the right one. Use the Switch Classes button at the top of the page.
 
**Check Pending Invitations:**
If another teacher transferred students to you, check **Settings → Pending Invitations** — you may need to accept the transfer first before the students appear in your class.
 
---
 
### A teacher I invited hasn't accepted yet
 
- Ask them to check their email — the invitation goes to the address you entered. Spam folder too.
- Check **Settings → Pending Invitations → Outgoing** to confirm it's still active
- If it expired (invitations expire after 30 days), cancel it and send a new one
...
- Your device type (iPhone, Android, iPad, etc.)
You can also email feedback@abcassess.app. Every bug report is read — by me, personally — and taken seriously. I can't fix what I don't know about, and even the smallest, most "this probably isn't worth mentioning" bug report is genuinely useful. If something felt off, told you something was wrong, or just didn't work the way you expected — please tell me. No report is too small.
...
See [Troubleshooting and FAQs](#troubleshooting-and-faqs) for more detail on submitting bug reports and feature ideas.
...
- Your device type (iPhone, Android, iPad, laptop, etc.)
...
All documents are kept up to date and versioned — the date and version number at the top of each document tells you exactly what you're reading.
...
- **In-app tips** — periodic feature highlights after you log in, introducing features you might not have found yet
- **Email notifications** — for significant updates or changes that affect your account
- **Support center** — documents are versioned and dated so you can always see what changed
---
...
[Accessibility Statement](accessibility.md) &nbsp;-&nbsp; [Data Processing Agreement](dpa.md) &nbsp;-&nbsp; [Privacy Policy](privacy-policy.md) &nbsp;-&nbsp; [Technical FAQs](technical-and-privacy-faqs.md) &nbsp;-&nbsp; [Terms of Service](terms-of-service.md) 
