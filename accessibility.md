...
* **Touch Target Accessibility:** All native mobile buttons, switches, and interactive roster targets maintain a minimum dimension of 48x48 pixels, ensuring rapid-fire proctoring actions can be accurately executed without accidental or misaligned taps.
* **Multimodal Asset Descriptions:** Non-decorative system images utilize explicit text alternatives. For teacher-curated custom items (such as uploaded instructional imagery or auditory prompts), our assessment builder provides configuration fields allowing educators to assign custom descriptive tags directly inside their workspace libraries.
